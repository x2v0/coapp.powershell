...
namespace ClrPlus.Windows.PeBinary.Utility {
    ...
    // remove this crap from here...
        ...
        public ExecutableInfo ExecutableInfo {
            get {
                return _executableInfo.Value;
            }
        }

        public ulong FileVersionLong {
            get {
                return IsPEBinary ? _fileVersionLong.Value : 0L;
            }
        }

        public string FileVersion {
            get {
                return IsPEBinary ? _fileVersionString.Value : "0.0.0.0";
            }
        }

        public FileVersionInfo VersionInfo {
            get {
                return IsPEBinary ? _fileVersionInfo.Value : null;
            }
        }
    ...
    // remove this crap
        ...
        private IEnumerable<DependencyInformation> DependencyInformationImpl {
            get {
                var depends = Environment.Is64BitOperatingSystem && (ExecutableInfo & this.ExecutableInfo.x64) == this.ExecutableInfo.x64
        ...
        public bool Is64BitPE {
            get {
                return IsPEBinary && (NtHeader.Magic == 0x20b);
            }
        }

        public bool Is32BitPE {
            get {
                return IsPEBinary && (NtHeader.Magic == 0x10b);
            }
        }

        public bool IsManaged {
            get {
                return IsPEBinary && CorHeader != null;
            }
        }
        ...
        public bool Is64Bit {
            get {
                return IsPEBinary && Is64BitPE;
            }
        }

        public bool IsAny {
            get {
                return IsPEBinary && (Is32BitPE && IsManaged && ((CorHeader.Flags & 0x0002) == 0));
            }
        }

        public bool IsConsole {
            get {
                return IsPEBinary && (NtHeader.SubSystem & 1) == 1;
            }
        }
        ...
        public long MetaDataRoot {
            get {
                return RvaToVa(CorHeader.MetaData.Rva);
            }
        }
        ...
        public static PEInfo Scan(string filename) {
            ...
            lock (_cache) {
                ...
                if (!_cache.ContainsKey(filename)) {
                    var result = new PEInfo(filename) {
                        MD5 = MD5
                    };
        ...
        public long RvaToVa(long rva) {
            ...
            throw new ClrPlusException("Invalid RVA address.");
        }
    }
}