    ...
    public class PeBinary : IDisposable {
                ...
                if (_mutableAssembly == null) {
                    ...
                    try {
                        ...
                        if (module == null || module is Dummy) {
                            throw new ClrPlusException("{0} is not a PE file containing a CLR module or assembly.".format(_filename));
                        }
        ...
        public static void StripSignatures(string filename) {
            ...
            using (var f = File.Open(filename, FileMode.Open)) {
                ...
                if (!rc) {
                    throw new ClrPlusException("Failed to find certificates in file {0}".format(filename));
                }
            ...
            get {
                if (_manifest == null) {
                    ...
                    if (_manifestResources.Count() > 1) {
                        throw new ClrPlusException("PE Binary with more than one manifest. Not yet supported. Wuff.");
                    }
