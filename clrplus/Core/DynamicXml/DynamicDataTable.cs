...
namespace ClrPlus.Core.DynamicXml {
    ...
    public class DynamicDataTable : DynamicObject, IEnumerable<DynamicDataRow> {
        ...
        /// <summary>
        ///     Gets the <see cref="DynamicDataRow" /> at the specified index.
        /// </summary>
        /// <remarks></remarks>
        public DynamicDataRow this[int index] {
            get {
                return new DynamicDataRow(_table.Rows[index]);
            }
        }

        /// <summary>
        ///     Gets the <see cref="DynamicDataRow" /> where the first column has the value given (ie, treats the first column in the table as a primary key).
        /// </summary>
        /// <remarks></remarks>
