...
namespace ClrPlus.Platform {
    ...
    public sealed class AlternateDataStreamInfo : IEquatable<AlternateDataStreamInfo> {
        ...
        /// </summary>
        /// <param name="mode">
        ///     A <see cref="FileMode" /> value that specifies whether a stream is created if one does not exist, and determines whether the contents of existing streams are retained or overwritten.
        /// </param>
        /// <param name="access">
