...
namespace ClrPlus.Platform {
    ...
    public struct Architecture : IComparable, IComparable<Architecture>, IEquatable<Architecture> {
        public static readonly Architecture Unknown = new Architecture {
            _architecture = ArchType.Unknown
        };

        public static readonly Architecture Auto = new Architecture {
            _architecture = ArchType.Auto
        };

        public static readonly Architecture Any = new Architecture {
            _architecture = ArchType.Any
        };

        public static readonly Architecture x86 = new Architecture {
            _architecture = ArchType.x86
        };

        public static readonly Architecture x64 = new Architecture {
            _architecture = ArchType.x64
        };

        public static readonly Architecture arm = new Architecture {
            _architecture = ArchType.arm
        };

        public static readonly Architecture[] Architectures = new[] {
            Any, x64, x86, Unknown
        };
        ...
        public static implicit operator Architecture(string architecture) {
            return new Architecture {
                _architecture = StringToArch(architecture)
            };
        }
        ...
        public static Architecture Parse(string input) {
            return new Architecture {
                _architecture = StringToArch(input)
            };
        }
