...
namespace ClrPlus.Platform {
    ...
    public static class FileSystem {
        ...
        /// </param>
        /// <returns>
        ///     A read-only list of <see cref="AlternateDataStreamInfo" /> objects representing the alternate data streams for the specified file, if any. If no streams are found, returns an empty list.
        /// </returns>
        /// <exception cref="ArgumentNullException">
        ///     <paramref name="file" />
        ///     is
        ...
        /// <returns>
        ///     A read-only list of <see cref="AlternateDataStreamInfo" /> objects representing the alternate data streams for the specified file, if any.
        /// </returns>
        /// <exception cref="ArgumentNullException">
