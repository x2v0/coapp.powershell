...
namespace ClrPlus.Console {
    ...
    public static class ConsoleExtensions {
        public static Lazy<SafeFileHandle> StandardOutputHandle = new Lazy<SafeFileHandle>(() => {return Kernel32.GetStdHandle(StandardHandle.OUTPUT);});

        public static Lazy<SafeFileHandle> StandardInputHandle = new Lazy<SafeFileHandle>(() => {return Kernel32.GetStdHandle(StandardHandle.INPUT);});

        public static Lazy<SafeFileHandle> StandardErrorHandle = new Lazy<SafeFileHandle>(() => {return Kernel32.GetStdHandle(StandardHandle.ERROR);});
