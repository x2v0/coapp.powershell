...
namespace ClrPlus.Scripting.Utility {
    ...
    ///         to handle certainly every c-style language, and probably most languages.
    ///     </para>
    ///     <para>
    ///         It should be pretty darned fast. Not the absolute fastest it could run, but a fair balance between
    ///         speed and complexity I'd wager.
    ///     </para>
    /// </summary>
    ...
    public class Tokenizer {
        ...
        public static readonly Token Space = new Token {
        ...
        public static readonly Token Tab = new Token {
            Type = TokenType.WhiteSpace,
            Data = "\t"
        };
        ...
        public static readonly Token PlusPlus = new Token {
            Type = TokenType.PlusPlus,
            Data = "++"
        };

        public static readonly Token PlusEquals = new Token {
        ...
        public static readonly Token MinusMinus = new Token {
            Type = TokenType.MinusMinus,
            Data = "--"
        };

        public static readonly Token MinusEquals = new Token {
            Type = TokenType.MinusEquals,
            Data = "-="
        };

        public static readonly Token DashArrow = new Token {
        ...
        public static readonly Token StarEquals = new Token {
        ...
        public static readonly Token EqualEqual = new Token {
            Type = TokenType.EqualEqual,
            Data = "=="
        };

        public static readonly Token Lambda = new Token {
        ...
        public static readonly Token SlashEquals = new Token {
            Type = TokenType.SlashEquals,
            Data = "/="
        };

        public static readonly Token Bar = new Token {
            Type = TokenType.Bar,
            Data = "|"
        };

        public static readonly Token BarBar = new Token {
            Type = TokenType.BarBar,
            Data = "||"
        };

        public static readonly Token BarEquals = new Token {
            Type = TokenType.BarEquals,
            Data = "|="
        };

        public static readonly Token Ampersand = new Token {
            Type = TokenType.Ampersand,
            Data = "&"
        };

        public static readonly Token AmpersandAmpersand = new Token {
            Type = TokenType.AmpersandAmpersand,
            Data = "&&"
        };

        public static readonly Token AmpersandEquals = new Token {
            Type = TokenType.AmpersandEquals,
            Data = "&="
        };

        public static readonly Token Percent = new Token {
            Type = TokenType.Percent,
            Data = "%"
        };

        public static readonly Token PercentEquals = new Token {
            Type = TokenType.PercentEquals,
            Data = "%="
        };

        public static readonly Token LessThan = new Token {
            Type = TokenType.LessThan,
            Data = "<"
        };

        public static readonly Token LessThanEquals = new Token {
        ...
        public static readonly Token BitShiftLeftEquals = new Token {
            Type = TokenType.BitShiftLeftEquals,
            Data = "<<="
        };

        public static readonly Token GreaterThan = new Token {
            Type = TokenType.GreaterThan,
            Data = ">"
        };

        public static readonly Token GreaterThanEquals = new Token {
        ...
        public static readonly Token BitShiftRightEquals = new Token {
            Type = TokenType.BitShiftRightEquals,
            Data = ">>="
        };

        public static readonly Token Bang = new Token {
            Type = TokenType.Bang,
            Data = "!"
        };

        public static readonly Token BangEquals = new Token {
            Type = TokenType.BangEquals,
            Data = "!="
        };

        public static readonly Token Dollar = new Token {
            Type = TokenType.Bang,
            Data = "$"
        };

        public static readonly Token Power = new Token {
            Type = TokenType.Power,
            Data = "^"
        };

        public static readonly Token PowerEquals = new Token {
            Type = TokenType.PowerEquals,
            Data = "^="
        };

        public static readonly Token Tilde = new Token {
            Type = TokenType.Tilde,
            Data = "~"
        };

        public static readonly Token QuestionMark = new Token {
            Type = TokenType.QuestionMark,
            Data = "?"
        };

        public static readonly Token QuestionMarkQuestionMark = new Token {
            Type = TokenType.QuestionMarkQuestionMark,
            Data = "??"
        };

        public static readonly Token OpenBrace = new Token {
            Type = TokenType.OpenBrace,
            Data = "{"
        };

        public static readonly Token CloseBrace = new Token {
        ...
        public static readonly Token Pound = new Token {
        ...
        protected bool IsCurrentCharacterHexadecimal {
            get {
                return (CurrentCharacter >= '0' && CurrentCharacter <= '9') || (CurrentCharacter >= 'a' && CurrentCharacter <= 'f') || (CurrentCharacter >= 'A' && CurrentCharacter <= 'F');
            }
        }
        ...
        protected virtual void ParseCharLiteral() {
            ...
            AdvanceAndRecognize();
            if (CurrentCharacter == '\\') {
                if (CurrentCharacter == '\'' || CurrentCharacter == '\"' || CurrentCharacter == '\\' || CurrentCharacter == '0' || CurrentCharacter == 'a' || CurrentCharacter == 'b' || CurrentCharacter == 'f' || CurrentCharacter == 'n' ||
                    CurrentCharacter == 'r' || CurrentCharacter == 't' || CurrentCharacter == 'v') {
                    AdvanceAndRecognize();
                ...
                while (Index < (Text.Length - 1)) {
                    if (Text[Index] == '*' && Text[Index + 1] == '/') {
                        AddToken(new Token {
                            ...
                            Data = new string(Text, start, (Index - start) + 2)
                        });
                        start = -1;
                        break;
                    }
